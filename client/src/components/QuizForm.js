...
const QuizForm = () => {
  ...
  return (
    <div className="container mt-4 text-light">
      <h3 style={{ color: "pink" }}>Create Quiz</h3>
      ...
      <div className="container mt-4">
        ...
        {queList.length === 0 ? (
          ...
          <>
            ...
            <button onClick={createQuiz} style={{ height: "fit-content", width: "fit-content", marginLeft: "auto" }} className='btn btn-success mb-4'>Create Quiz</button>
          </>
        )}
      </div>
    </div>
